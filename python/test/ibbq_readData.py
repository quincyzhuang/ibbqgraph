...
#notify = bytearray([0x01,0x00])
notify = '\x01\0'
#authData = bytearray([0x21,0x07,0x06,0x05,0x04,0x03,0x02,0x01,0xB8,0x22,0x00,0x00,0x00,0x00,0x00])
authData = '\x21\x07\x06\x05\x04\x03\x02\x01\xb8\x22\0\0\0\0\0'
#rtEnable = bytearray([0x0B, 0x01, 0x00, 0x00, 0x00, 0x00])
rtEnable = '\x0b\x01\0\0\0\0'
#batteryEnable = bytearray([0x08, 0x24, 0x00, 0x00, 0x00, 0x00])
